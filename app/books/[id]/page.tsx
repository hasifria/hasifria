    ...
    <div className="flex flex-col min-h-screen bg-[#0f0f0f]">
      ...
      <main className="flex-1">
        ...
        <div className="max-w-6xl mx-auto px-4 pb-16">
          <div className="bg-[#1e1e1e] rounded-2xl border border-[#2a2a2a] p-6 flex flex-col sm:flex-row gap-6 mb-6">
            {/* Cover */}
            ...
            <div className="flex-1">
              ...
              <div className="mt-4">
                <Link
                  ...
                  className="inline-block bg-[#F5A623] hover:bg-[#e0941a] transition-colors text-black font-medium py-2 px-5 rounded-xl text-sm"
                >
                  פרסם מודעה לספר זה
                </Link>
              </div>
